...
#        self.real1 = tf.maximum(0.0, self.real1 - self.other1 +self.CONFIDENCE)
    ...
    def attack_batch(self, gray_img, img, img_t1, img_t2, img_t3, img_id, checkpoint):
        """
        ...
        img_t3 = img_t3.astype(np.float32)
...
#            self.modifier_down = 0- img.reshape(-1)
        ...
        for outer_step in range(binary_search_step):
            ...
            self.sess.run(self.setup, {self.assign_timg: img, self.assign_timg1: img_t1, self.assign_timg2: img_t2, self.assign_timg3: img_t3, self.assign_const: CONST})
